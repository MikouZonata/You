...
////// Emissive:
                ...
                float2 node_185 = ((float2(_U_Speed_copy,_V_Speed_copy)*node_8091.g)+i.uv0);
                float4 node_1221 = tex2D(_MainTexture,TRANSFORM_TEX(node_185, _MainTexture));
