...
////// Emissive:
                ...
                float2 node_2098 = ((float2(_U_Speed_copy,_V_Speed_copy)*node_4773.g)+i.uv0);
                float4 node_1221 = tex2D(_MainTexture,TRANSFORM_TEX(node_2098, _MainTexture));
